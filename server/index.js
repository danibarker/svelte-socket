import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component, n as noop, a as safe_not_equal } from './chunks/index-e1ead145.js';
import { H as HttpError, R as Redirect, V as ValidationError, j as json, e as error } from './chunks/index2-1a2749b7.js';
...
function get_cookies(request, url) {
  ...
  const cookies = {
    get(name, opts) {
      ...
      const req_cookies = parse_1(request.headers.get("cookie") ?? "", { decode });
